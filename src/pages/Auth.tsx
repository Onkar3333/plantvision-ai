...
import { Mail, Lock, User, Eye, EyeOff, Leaf, ArrowRight, UserCircle, GraduationCap } from "lucide-react";
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <Link to="/dashboard">
                <motion.button
                  type="button"
                  className="w-full btn-neon py-4 flex items-center justify-center gap-2 mt-6"
